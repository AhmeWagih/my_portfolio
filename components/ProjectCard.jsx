...
const ProjectCard = ({
  ...
  return (
    <motion.div
      ...
      className="overflow-hidden relative flex items-center justify-center h-auto w-full shadow-xl shadow-gray-400 rounded-xl p-4 group hover:bg-gradient-to-r from-[#5651e5] to-[#709dff]"
    >
      <Image
      ...
      <div className="hidden group-hover:block absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] w-full">
        ...
        <p className="p-4 text-white text-center w-full">{description}</p>
