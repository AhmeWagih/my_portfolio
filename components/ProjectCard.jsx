...
const ProjectCard = ({
  ...
  return (
    <motion.div
      ...
      className="overflow-hidden relative flex items-center justify-center shadow-xl shadow-gray-400 rounded-xl p-4 group hover:bg-gradient-to-r from-[#5651e5] to-[#709dff]"
    >
